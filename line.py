...
print(f"El coeficiente A de su ecuacion de la recta es: {B}")
print(f"El coeficiente A de su ecuacion de la recta es: {X1}")
print(f"El coeficiente A de su ecuacion de la recta es: {X2}")
